                      ...
                      <div className="space-y-6 flex-grow">
                        ...
                        <div className="p-6 bg-slate-900 border border-slate-800 rounded-3xl max-w-2xl mx-auto space-y-6 shadow-xl">
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-slate-800">
                            ...
                            <div>
                              <span className="text-[10px] text-amber-500 block">Horas de Corretores Desperdiçadas</span>
                              <span className="text-base font-bold text-amber-500 font-mono">{filterMetrics.brokerWastedHours}h</span>
                            </div>
                          </div>
